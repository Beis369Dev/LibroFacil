...
const inputs= document.querySelectorAll('#formNewUser input');
...
formUser.addEventListener('submit',(e)=>{
	...
	if (statusInput.name && statusInput.lastName && statusInput.email && statusInput.password &&  statusInput.phone && statusInput.password2 && terms.checked ){
		SendJson();
